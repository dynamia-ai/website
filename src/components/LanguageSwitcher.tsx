  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        ...
        className="min-w-[8.5rem] rounded-lg border-0 bg-white p-1 shadow-lg ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10"
      >
        {routing.locales.map((loc) => {
          ...
          return (
            <DropdownMenuItem
              ...
              className={cn(
                "justify-between gap-3 rounded-md px-2.5 py-2",
                "focus:bg-gray-100 dark:focus:bg-gray-800",
                !isActive && "text-muted-foreground"
              )}
            >
              <span className={cn("truncate", isActive && "font-medium text-primary")}>
                {t(loc)}
              </span>
              <Check
