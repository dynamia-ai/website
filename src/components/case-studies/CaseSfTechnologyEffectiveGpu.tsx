        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 dark:[&>*]:bg-gray-800 dark:[&>*]:border-gray-700">
            {(function() {
              ...
              >
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-8 h-8 bg-[#76b900] rounded-full flex items-center justify-center mr-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {(function() {
              ...
              >
                ...
                <p className="text-2xl font-bold text-[#76b900] my-4">{item.value}</p>
          ...
          <div className="space-y-6">
            {(function() {
              ...
              <motion.div
                ...
                variants={fadeIn}
                transition={{ duration: 0.5, delay: 0.1 * index }}
                className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-gray-800 dark:to-gray-800 p-6 rounded-lg border-l-4 border-[#76b900]"
              >
                <div className="flex items-start">
