...
export default function Home() {
  ...
  const featureTabs = t.raw('home.keyAdvantages.tabs');
      ...
      */}
          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-4 max-w-6xl mx-auto">
            ...
            >
              <Link href="https://cloud-native.slack.com/archives/C07T10BU4R2" className="flex flex-col items-center">
                <div className="w-10 h-10 md:w-12 md:h-12 mb-2 md:mb-3 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.8 122.8" width="32" height="32" className="md:w-[36px] md:h-[36px]">
            ...
            >
              <Link href="https://discord.gg/AgdQt5Xp" className="flex flex-col items-center">
                <div className="w-10 h-10 md:w-12 md:h-12 mb-2 md:mb-3 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 127.14 96.36" width="32" height="32" className="md:w-[36px] md:h-[36px]">
            ...
            >
              <Link href="https://www.reddit.com/r/HAMi_Community/" className="flex flex-col items-center">
                <div className="w-10 h-10 md:w-12 md:h-12 mb-2 md:mb-3 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="32" height="32" className="md:w-[36px] md:h-[36px]">
                    <g>
            ...
            >
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 md:w-12 md:h-12 mb-2 md:mb-3 flex items-center justify-center">
                  <svg width="32" height="32" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="md:w-[36px] md:h-[36px]">
      ...
      <section className="py-12 md:py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div
              ref={ecosystemRef}
              className="flex flex-nowrap gap-4 md:gap-6 overflow-x-auto scroll-smooth py-2 px-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
            ...
            {/* Indicators */}
            <div className="absolute left-1/2 -translate-x-1/2 -bottom-8 md:bottom-[-28px] flex items-center gap-2">
              {Array.from({ length: ecoCount }).map((_, i) => (
                <button
                  key={i}
                  aria-label={`Go to slide ${i + 1}`}
                  onClick={() => scrollToIndex(i)}
                  className={`${i === ecoIndex ? 'bg-primary' : 'bg-gray-300'} w-2 h-2 md:w-2.5 md:h-2.5 rounded-full transition-colors`}
                />
              ))}
            </div>
          </div>
      ...
      <section className="py-12 md:py-16 bg-primary text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 md:mb-6">{t('home.cta.title')}</h2>
