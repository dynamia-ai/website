...
export default function HamiPage() {
  const t = useTranslations('hamiPage');
          ...
          <div className="grid md:grid-cols-5 gap-12 items-center">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 leading-tight">
                ...
                {' '}<span className="text-[#76b900]">HAMi</span>?
              </h1>
                ...
                <div className="flex flex-wrap items-center justify-around">
                  <div className="mb-4 md:mb-0 text-center px-4">
                    <div className="flex items-center justify-center">
                      <FontAwesomeIcon icon={faUsers} className="h-5 w-5 text-[#76b900] mr-1" />
                      <span className="text-2xl font-bold text-[#76b900]">{home('poweredByHami.stats.contributors')}</span>
                    </div>
                  ...
                  <div className="mb-4 md:mb-0 text-center px-4">
                    <div className="flex items-center justify-center">
                      <FontAwesomeIcon icon={faCodeCommit} className="h-5 w-5 text-[#76b900] mr-1" />
                      <span className="text-2xl font-bold text-[#76b900]">{home('poweredByHami.stats.commits')}</span>
                    </div>
                  ...
                  <div className="text-center px-4">
                    <div className="flex items-center justify-center">
                      <FontAwesomeIcon icon={faDocker} className="h-5 w-5 text-[#76b900] mr-1" />
                      <span className="text-2xl font-bold text-[#76b900]">{home('poweredByHami.stats.dockerPulls')}</span>
                    </div>
                    <span className="text-gray-600 dark:text-gray-300">[ Docker Pulls ]</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <a
              ...
              className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-[#76b900] hover:bg-[#6ba300] shadow-md transition-colors"
            >
