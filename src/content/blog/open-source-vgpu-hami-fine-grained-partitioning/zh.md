...
首先在 k8s 中资源是和节点绑定的，对于 GPU 资源，我们只用 NVIDIA 提供的 device plugin 进行感知，并上报到 Kube-apiserver，这样我们就能在 Node 对象上看到对应的资源了。
...
但是现在比较完善的是对 NVIDIA GPU 的 vGPU 方案，因此我们可以简单认为他就是个 vGPU 方案。
